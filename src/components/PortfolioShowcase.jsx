...
import { FiCode, FiAward, FiLayers, FiExternalLink, FiEye, FiX } from 'react-icons/fi';
                  ...
                  <div key={`${project.id}-${idx}`} className="project-card">
                    ...
                    <div className="project-content">
                      ...
                      <div className="project-actions">
                        {project.liveDemo ? (
                          <a href={project.liveDemo} target="_blank" rel="noreferrer" className="action-link primary">
                            Live Demo <FiExternalLink />
                          </a>
                        ) : (
                          <span className="action-link disabled">Coming Soon</span>
                        )}
                        {project.github ? (
                          <a href={project.github} target="_blank" rel="noreferrer" className="action-link secondary">
                            Details →
                          </a>
                        ) : (
          ...
          <div className="tab-panel fade-in-up tech-wrapper">
            ...
            <div className="tech-grid">
              {allSkills.map((skill, sIdx) => {
                ...
                return (
                  <div key={sIdx} className="tech-square-card">
                    <div className="tech-icon-container">
                      <Icon className="tech-card-icon" style={{ color: skill.color }} />
                    </div>
                    <span className="tech-card-label">{skill.name}</span>
                  </div>
                );
              })}
            </div>
